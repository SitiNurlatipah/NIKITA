                        ...
                        <div class="col-12 flex">
                                ...
                                @endif
                                    <div class="table-responsive">
                                            <table class="display expandable-table table-striped table-hover" id="table-taging-champion" style="width:100%">
                                                <thead>
                                                    <tr>
                                                        <th>No Taging</th>
                                                        <th>NIK</th>
...
<div class="modal fade" id="modal-tambah" tabindex="-1" role="dialog" aria-labelledby="modal-tambahLabel" aria-hidden="true">
    <div class="modal-dialog modal-xl" role="document">
        <div class="modal-content">
            ...
            <form action="{!!route('champion.actionTagingList')!!}" method="post" enctype="multipart/form-data" id="formTaging">
                @csrf
...
<div class="modal fade" id="modal-export" tabindex="-1" role="dialog" aria-labelledby="modal-exportLabel" aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document" style="width:45%">
        <div class="modal-content">
            ...
            <form action="{!!route("champion.exportTaggingList")!!}" method="get">
...
<script type="text/javascript">
      ...
      $("#formSubmit").click(function (e) {
          ...
          $.ajax({
              ...
              success:function (data) {
                  $('#table-taging-champion').DataTable().destroy();
                  iniDatatable();
  ...
  function formTaging(el) {
      ...
      const url = "{!! route('champion.tagingForm') !!}?white_tag_id="+whiteTagId+"&reasonTagId="+reasonTagId;
      $.ajax({
          url:url,
          cache:false,
  ...
  function detailTaging(id) {
      ...
      $.ajax({
          url:"{!!route('champion.tagingDetail')!!}?id="+id,
          cache:false,
          success:function (html) {
  ...
  function printCompetencyTag(el) {
    ...
    window.open(
        '{!!route("champion.taggingPrint")!!}?id='+id,
        '_blank'
    );
  }
  ...
  function iniDatatable() {
      var dtJson = $('#table-taging-champion').DataTable({
          ajax: "{{ route('champion.tagging.json') }}",
          responsive:true,
          serverSide: true,
          processing: true,
          aaSorting: [
