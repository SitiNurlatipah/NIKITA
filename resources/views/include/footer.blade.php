...
<footer class="footer">
    ...
    <div class="d-sm-flex justify-content-center justify-content-sm-between">
        <span class="text-muted text-center text-sm-left d-block d-sm-inline-block">Build by <a href="https://www.soultechonoly88.blogspot.com/" target="_blank">Human Capital</a></span>
    </div>
    <div class="myk-wa">
